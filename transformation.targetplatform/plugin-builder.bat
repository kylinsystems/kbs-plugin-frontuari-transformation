...
call mvn validate -Didempiere.target=transformation.p2.targetplatform %DEBUG_MODE%
call mvn verify -Didempiere.target=transformation.p2.targetplatform %DEBUG_MODE%
